...
function TrollModule.Init(TrollTab)
    ...
    TrollTab:CreateDropdown({
        ...
        Callback = function(option)
            ...
            if SpectateEnabled then TrollModule.UpdateSpectate(SelectedPlayer, SpectateEnabled) end
            if ESPEnabled then TrollModule.UpdateESP(SelectedPlayer, ESPEnabled) end
        end,
    })
    ...
    function TrollModule.UpdateSpectate(selectedPlayer, enabled)
    ...
    TrollTab:CreateToggle({
        ...
        Callback = function(v)
            SpectateEnabled = v
            TrollModule.UpdateSpectate(SelectedPlayer, v)
        end,
    })
    ...
    function TrollModule.UpdateESP(selectedPlayer, enabled)
    ...
    TrollTab:CreateToggle({
        ...
        Callback = function(v)
            ESPEnabled = v
            TrollModule.UpdateESP(SelectedPlayer, v)
        end,
    })
